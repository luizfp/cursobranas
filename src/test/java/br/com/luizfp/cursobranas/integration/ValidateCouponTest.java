...
public class ValidateCouponTest {
    ...
    void shouldValidateACoupon() {
        ...
        Mockito.when(couponRepository.getByCode("10OFF")).thenReturn(Optional.of(coupon));
    ...
    void shouldThrowsExpiredCoupon() {
        ...
        Mockito.when(couponRepository.getByCode("OVERDUE")).thenReturn(Optional.of(coupon));
        final ValidateCoupon validateCoupon = new ValidateCoupon(couponRepository);
        final OffsetDateTime now = OffsetDateTime.parse("2021-01-01T10:00:00+00:00");
